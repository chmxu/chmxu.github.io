...
Output exactly 8 separate animation frames arranged left-to-right in one single row. Each frame must show the same pet: Compact chibi digital pet based on the reference girl: black bob hair with straight bangs, soft expressive eyes, lavender-and-white frilly idol outfit, oversized bow, lace trim, tiny veil/ribbon accent, pastel shoes, pearl-like tiny details simplified for sprite readability..
